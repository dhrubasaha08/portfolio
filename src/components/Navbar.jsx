  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-start mx-auto'>
        ...
        >
          <p className='text-white text-[26px] lg:text-[36px] font-bold pointer-events-auto cursor-pointer flex ml-[-28px]'>
            <img src="https://avatars.githubusercontent.com/u/78276433" alt="Dhruba Saha" className="w-9 h-9 lg:w-14 lg:h-14 mr-2 rounded-full border-4 border-primary-color"/>Portfolio
          </p>
        </Link>
