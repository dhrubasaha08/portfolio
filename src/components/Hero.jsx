...
const Hero = ({ scrollContainer }) => {
  return (
    <section className="parallax">
      <div className='parallax__content absolute top-[10%] sm:top-[16%] lg:top-[12%] w-full mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-70 xl:pr-72 2xl:px-30 3xl:px-60 flex flex-col lg:flex-row items-start z-10 ml-4'>
